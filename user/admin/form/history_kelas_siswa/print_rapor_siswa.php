...
$html .= '
     <tr>
        <td colspan="4" align="center">JUMLAH NILAI = '.$total_nilai.'</td>
      </tr>
     <tr>
        <td colspan="4" align="center">RATA RATA = '.$show_ratarata.'</td>
      </tr>
    </table>
      <br>
';
...
Medan, '.date('d').' '.$nama_bulan[date('n')].' '.date('Y').' <br>
...
Mengetahui, <br>
KEPALA SEKOLAH SDS HARAPAN BARU
 <br> <br> <br> <br>
Lasmaria Simamora, S.Pd <br>
NIP : 234567 891 098
</center>
</div>';
