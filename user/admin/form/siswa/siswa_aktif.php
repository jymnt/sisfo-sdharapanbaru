...
<div class="box-header with-border">
  <h3 class="box-title">Data Siswa Aktif 
  </h3>
  <div class="pull-right"><!-- <a href="?a=tambah_siswa" class=" btn btn-info btn-sm" >Tambah Siswa</a> -->
  </div>
...
$tgll = $pt[2].'-'.$pt[1].'-'.$pt[0];?>
	...
	<td><a href="?a=detail_siswa&id=<?php echo $data['id_siswa'] ?>&t=0&status=1" class="btn btn-info btn-xs">Detail Siswa</a> 
	</td>
		</tr>
