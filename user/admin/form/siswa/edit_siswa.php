               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select class="form-control" name="status_siswa" id="status_siswa">
                    	<option value="Aktif" <?php if($d['status_siswa']=='Aktif'){echo "selected";} ?>>Aktif</option>
                    	<option value="Calon Siswa" <?php if($d['status_siswa']=='Calon Siswa'){echo "selected";} ?>>Calon Siswa</option>
                    	<option value="Siswa Pindahan" <?php if($d['status_siswa']=='Siswa Pindahan'){echo "selected";} ?>>Siswa Pindahan</option>
                    </select>
                  </div>
                </div>   
                ...
                <div id="show_pindahan" <?php if($d['status_siswa']!='Siswa Pinedahan'){echo 'hidden="true"';} ?>>
	                <div class="form-group">
