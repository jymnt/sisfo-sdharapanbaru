...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-lg" style="font-size:15px"><b>SDS HARAPAN BARU</b></span>
    </a>
  ...
  <aside class="main-sidebar" style="">
   ...
   <li class="treeview">
        ...
        <li><a href="?a=guru"><i class="fa fa-user"></i> <span>Data Guru </span></a></li>      
        <li><a href="?a=kelas"><i class="fa fa-book pull-right"></i> <span>Kelas</span></a></li>      
        <li><a href="?a=mapel"><i class="fa fa-book pull-right"></i> <span>Mata Pelajaran</span></a></li>      
        <li><a href="?a=tahun_ajaran"><i class="fa fa-book pull-right"></i> <span>Tahun Ajaran</span></a></li>      
        <li><a href="?a=pengumuman"><i class="fa fa-book pull-right"></i> <span>Pengumuman</span></a></li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-table"></i> <span>Keuangan</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="?a=penunjang"><i class="fa fa-circle-o"></i>Penunjang Belajar</a></li>
            <li><a href="?a=pengambilan"><i class="fa fa-circle-o"></i>Hutang Piutang</a></li>
            <!-- <li><a href="?a= q"><i class="fa fa-circle-o"></i>Hutang Piutang</a></li> -->
         <!--    <li class="treeview">
              <a href="#">
                <i class="fa fa-table"></i> <span>Daftar Harga</span>
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <li><a href="?a=calon_siswa"><i class="fa fa-circle-o"></i>Pengambilan LKS</a></li>
        ...
        <?php }else{ ?>
        <li><a href="?a=pengumuman"><i class="fa fa-book"></i> <span>Pengumuman</span></a></li>  
        <li><a href="?a=siswa_pj_wk"><i class="fa fa-book"></i> <span>Nilai Siswa</span></a></li>      
        <li><a href="?a=absensi"><i class="fa fa-book"></i> <span>Absensi Siswa</span></a></li> 
        <!--  <li class="treeview">
          <a href="#">
