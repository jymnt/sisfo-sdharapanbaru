...
<html lang="zxx">
  ...
  <body>
    <!--headder-->
    <div class="header-outs inner_page-banner " id="home" style="background: url(images/bg3.png) no-repeat center;background-size: cover;">
      <div class="headder-top">
        <!--//navigation section -->
        <!-- nav -->
        <nav>
          <div id="logo">
            <h1><a href="index.php">SD HARAPAN BARU MEDAN</a></h1>
          </div>
          <label for="drop" class="toggle">Menu</label>
          <input type="checkbox" id="drop">
         <ul class="menu mt-2">
            <li class="active"><a href="index.php">Beranda</a></li>
            <li class="mx-lg-3 mx-md-2 my-md-0 my-1"><a href="tentang.php">Tentang Kami</a></li>
